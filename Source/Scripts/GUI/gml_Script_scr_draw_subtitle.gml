scr_draw_subtitle = function(argument0, argument1, argument2) //gml_Script_scr_draw_subtitle
{
    if ((!instance_exists(obj_player)) and room != level_basic_copy_me)
        return;
    ...
    {
        if (room == AngerManagementRoom || room == level_basic_copy_me)
			yypos = 1
        else
        {
